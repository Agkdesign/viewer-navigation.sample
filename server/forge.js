...
var ossBucketKey = process.env.FORGE_BUCKET || 'agkfmbim1';
...
router.get('/forge/initialsetup', function (req, res) {
  ...
  uploadToOSS('revithouse.rvt', path.join(__dirname, '..', 'https://github.com/Agkdesign/viewer-navigation.sample/tree/master/samples/TC1.dwg'), req, res, function () {
    uploadToOSS('racadvanced.rvt', path.join(__dirname, '..', '/samples/TC1.dwg'), req, res, function () {
